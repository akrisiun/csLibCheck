...
namespace SigHelper {
	...
	public class CsPropertyInfo : GenPropertyInfo {
		...
		public override string ToString() {
            ...
            if (_getter != null)
            {
                temp = ToString(_getaccess);
				result += (temp != String.Empty && temp != "public" ? temp + " " : "") + "get; ";		// Getter
            }
			if (_setter != null)
            {
                temp = ToString(_setaccess);
				result += (temp != String.Empty && temp != "public" ? temp + " " : "") + "set; ";		// Setter
            }
			result += "}";
			return result;
		}
